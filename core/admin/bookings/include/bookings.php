         ...
         <table class="bookings-table">
            <tbody>
               <tr class="thead">
                  ...
                  <td class="booking-status-col" width="5%"><?php echo __('Status','eagle-booking') ?></td>
                  <td width="5%"><?php echo __('Source','eagle-booking') ?></td>
               ...
               <?php
                  ...
                  foreach ( $eb_bookings as $eb_booking ) {
                     ...
                     if ( isset( $eb_booking_source->meta_value ) ) {
                        ...
                        if ( $eb_booking_source == 'external') {

                           $eb_booking_source_text = __('External', 'Eagle Booking');

                        } elseif ( $eb_booking_source == 'admin') {
                  ...
                  <tr class="eb-booking-line" data-booking-id="<?php echo $eb_booking_id ?>">
                     ...
                     <td><?php echo $eb_booking_source_text ?></td>
                     <td>
                        <div class="eb-action-buttons">

                           <?php if ( $eb_booking_source == 'external' ) : ?>
