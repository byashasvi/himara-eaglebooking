...
Redux::setSection( $opt_name, array(
        ...
        'fields'      => array(
          ...
          array(
              ...
              'subtitle'   => esc_html__( 'Set the % of the total price', 'eagle-booking' ),
              'default'    => '100',
              "min"       => 1,
              "step"      => 1,
              "max"       => 100,
...
Redux::setSection( $opt_name , array(
    ...
    'fields'          => array(
        ...
        array(
            'id'         => 'sync_calendars',
            'type'       => 'switch',
            'title'      => esc_html__( 'Sync Calendars', 'eagle-booking' ),
            'subtitle'   => esc_html__( 'Enable/Disable external calendars synchronization', 'eagle-booking' ),
            'default'    => true,
        ),

        array(
            'id'         => 'auto_sync_calendars',
            'type'       => 'switch',
            'title'      => esc_html__( 'Auto Sync Calendars', 'eagle-booking' ),
            'subtitle'   => esc_html__( 'Enable/Disable auto calendars synchronization', 'eagle-booking' ),
            'default'    => true,
            'required'    => array( 'sync_calendars', '=', true ),

        ),


        array(
            'id'          => 'sync_calendars_interval',
            'type'     => 'select',
            'title'    => __('Calendars Synchronization Interval', 'eagle-booking'),
            'subtitle'     => esc_html__( 'Set the interval of the external calendars synchronization', 'eagle-booking' ),
            'class'    => 'small-select',
            'options'  => array(
                '1800' => __('Every 30 Minutes', 'eagle-booking'),
                '3600' => __('Every 1 Hour', 'eagle-booking'),
                '7200' => __('Every 2 Hours', 'eagle-booking'),
                '43200' => __('Twice Daily', 'eagle-booking'),
                '86400' => __('Once Daily', 'eagle-booking')
            ),

            'default'  => '43200',
            'required'    => array( 'auto_sync_calendars', '=', true ),
        ),
